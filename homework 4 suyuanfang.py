...
# Convert FRED monthly CPI data to annual by averaging over each year
...
final_df.to_csv('/Users/suyuanfang/Documents/GitHub/datasci-harris-suyuan-fang/q1.csv', index=False)
print(final_df)
...
df = pd.DataFrame([x.split(',', 1) for x in csv_doc], columns=['Type', 'Description'])
df.to_csv('/Users/suyuanfang/Documents/GitHub/datasci-harris-suyuan-fang/q2.csv', index=False)
